...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let thisid = new_id () in
    evt := {id = thisid; action = listener} :: !evt ;
    thisid
...
let fakeNewsNetwordId = WEvent.add_listener newswire fakeNewsNetwork ;;
let buzzFakeId = WEvent.add_listener newswire buzzFake ;;
...
(* .. *)
WEvent.remove_listener newswire fakeNewsNetwordId ;;
WEvent.remove_listener newswire buzzFakeId ;;
